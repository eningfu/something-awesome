      ...
      <div>
        ...
        <div class="explainer">
          <p class="silkscreen-regular" style={{ textAlign: 'left' }}>
            ...
            can encompass a wide range of data, including IP addresses, which can be analysed to 
            identify ownership, geographical location, and associated network details.
            <br/>
            <br/>
            When analysing a photo, OSINT techniques can reveal hidden information. Metadata 
